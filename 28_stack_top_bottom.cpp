// StackTop , StackBottom Operations in Stack Using Arrays
...
int main()
{
    ...
    cout<<"The topmost value of this Stack is "<<sp->StackTop(sp)<<endl;
    cout<<"The Bottommost value of this Stack is "<<sp->StackBottom(sp)<<endl;
